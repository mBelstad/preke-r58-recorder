...
**Remote Access**:
- Mixer: https://vdo.itagenten.no/mixer.html?mediamtx=r58-mediamtx.itagenten.no
- Director: https://vdo.itagenten.no/?director=r58studio&mediamtx=r58-mediamtx.itagenten.no
...
flowchart TB
    ...
    subgraph VPS[Cloud VPS]
        FRP[FRP Tunnel]
        VDOVPS[VDO.ninja Access<br/>vdo.itagenten.no]
    end
...
- Mixer: https://vdo.itagenten.no/mixer?room=r58studio
- Director: https://vdo.itagenten.no/?director=r58studio

**WHEP Integration**:
Add WHEP URLs to mixer:
- &whep=https://r58-mediamtx.itagenten.no/cam0/whep
- &whep=https://r58-mediamtx.itagenten.no/cam1/whep
- etc.
...
- Access at: https://vdo.itagenten.no/mixer
...
- Remote: https://vdo.itagenten.no/mixer?room=r58studio
