function n(){return"r58-vdo.itagenten.no"}function c(){return"https"}const u="studio",i="preke-r58-2024";function d(){var e,t;const o=`
...
`;if(typeof window<"u"&&((t=(e=window.location)==null?void 0:e.origin)!=null&&t.startsWith("file://")))return"";try{return"b64:"+btoa(unescape(encodeURIComponent(o)))}catch{return""}}function m(o){const e=n(),t=c(),r=new URL(`${t}://${e}/`);return r.searchParams.set("scene",""),r.searchParams.set("room",u),r.searchParams.set("cover",""),r.searchParams.set("quality","2"),r.searchParams.set("cleanoutput",""),r.searchParams.set("hideheader",""),r.searchParams.set("nologo",""),r.searchParams.set("whipout",o),r.searchParams.set("autostart",""),r.searchParams.set("videodevice","0"),r.searchParams.set("audiodevice","0"),r.searchParams.set("css",d()),r.toString()}function l(o,e={}){const t=n(),r=c(),a=new URL(`${r}://${t}/`);a.searchParams.set("scene",o.toString()),a.searchParams.set("room",e.room||u),a.searchParams.set("password",i),a.searchParams.set("cover",""),a.searchParams.set("cleanoutput",""),a.searchParams.set("hideheader",""),a.searchParams.set("nologo",""),a.searchParams.set("quality",(e.quality??2).toString()),e.muted&&a.searchParams.set("muted","");const s=d();return s&&a.searchParams.set("css",s),a.toString()}function b(o=1,e){return l(o,{muted:!1,quality:2,room:e})}function h(o=1){const e=b(o),r=window.open(e,"R58_Program_Output","width=1280,height=720,menubar=no,toolbar=no,location=no,status=no");return r||console.warn("[VDO.ninja] Popup blocked - please allow popups for this site"),r}export{u as V,n as a,m as b,i as c,d,c as g,h as o};
