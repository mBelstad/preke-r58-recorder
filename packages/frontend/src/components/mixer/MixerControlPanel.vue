...
const vdo = props.iframeRef ? useVdoNinja(props.iframeRef) : null
const vdoSources = computed(() => vdo?.sources.value || new Map())
const isRecording = computed(() => vdo?.isRecording.value || false)
