#!/bin/bash
# Fix VDO.ninja publisher services - remove password hashing, salt, and add --noaudio

set -e

echo "🔧 Fixing VDO.ninja publisher services (v2 - with --noaudio)..."
...
sudo journalctl -u ninja-publish-cam1 --since "10 seconds ago" --no-pager | grep -E "streamID|Stream Ready|joining" | tail -5

echo ""
echo "✅ Done! Stream IDs should be r58-cam1, r58-cam2, r58-cam3 (no hash suffix)"
